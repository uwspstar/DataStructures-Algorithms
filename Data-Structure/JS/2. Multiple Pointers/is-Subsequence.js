...
const isSubsequence = function (str1, str2) {
    ...
    if (str2.length < str1.length) return isSubsequence(str2, str1); // good
...
console.log('isSubsequence', isSubsequence('hello', 'he he llo world')); // false
console.log('isSubsequence', isSubsequence('hello', 'he hello world')); // true
console.log('isSubsequence', isSubsequence('sing', 'sting')); // true
console.log('isSubsequence', isSubsequence('abc', 'abracadabra')); // true
console.log('isSubsequence', isSubsequence('abc', 'acb')); // false (order matters)
